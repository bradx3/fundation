...
dt.save!
dt.deposit_template_account_percentages.new(:account => tax, :percentage => 35).save!
dt.deposit_template_account_percentages.new(:account => home_loan, :percentage => 30).save!
dt.deposit_template_account_percentages.new(:account => expenses, :percentage => 35).save!
